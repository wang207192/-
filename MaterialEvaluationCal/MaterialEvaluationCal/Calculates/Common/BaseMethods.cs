...
namespace MaterialEvaluationCal.Calculates
{
    public partial class BaseMethods : BaseData
    {
        ...
        public bool Calculate(IDictionary<string, IList<IDictionary<string, string>>> dataExtra, ref IDictionary<string, IDictionary<string, IList<IDictionary<string, string>>>> retData, out string err)
        {
            err = "";
            dataExtraTmp = dataExtra;
            retDataTmp = retData;
            return Calculates.JGJ18_2012.Calc(dataExtra, ref retData, ref err);
        }
